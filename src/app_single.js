...
const url = 'mongodb://docker:27017/testdb',
    types = [100, 210, 210, 210, 210, 210, 210, 210, 210, 210, 210, 210, 210, 220, 230, 240, 250, 260],
    n = 100000;
...
function prepareData() {
    let result = Object.assign({}, data),
        global_type = (types[Math.floor(Math.random() * types.length)]).toString();

    result.msisdn = getRandomInt(79211000000, 79219999999).toString();
    result.global_type = Number.parseInt(global_type + result.msisdn);
